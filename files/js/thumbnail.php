...
if(! defined('MIN_WIDTH') )					define ('MIN_WIDTH', 700);								// Maximum image width
if(! defined('MIN_HEIGHT') )				define ('MIN_HEIGHT', 394);							// Maximum image height
...
if(! defined('DEFAULT_WIDTH') )				define ('DEFAULT_WIDTH', 1366);							// Default thumbnail width. Allows overrid in timthumb-config.php
if(! defined('DEFAULT_HEIGHT') )			define ('DEFAULT_HEIGHT', 768);							// Default thumbnail height. Allows overrid in timthumb-config.php
