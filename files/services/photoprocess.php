<?php
    ...
    imagecopyresampled($imw, $im, $xxx,$yyy,0,0,$x,$y,imagesx($im), imagesy($im));
		...
		{
        if($_GET['watermark_color'])
			{
			$watermark_color=$_GET['watermark_color'];
			}
		else
			{
        ...
        $font = "georgia.ttf"; //this font(georgia.ttf Allstar Regular.ttf  pirulen) heave to be in the same directory as this script
