		...
		"query": {
			"bool" : {
				"filter" : {
					"bool" : {
						"must" : [
							'.$concatstr.' , { "range" : { "ddate" : { "lt" : "'.$urlsno.'" } } } 
						]
					}
				}
			}
							...
							?>
								...
								<div id="stexpandbox<?php echo $r['_source']['sno'];?>" >
									<div id="stexpand6">
										...
										<img src="thumbnail.php?src=<?php echo $imageDataEncoded; ?>&w=200&h=113"  onclick="popupgallery('popUpDivgallery','<?php echo $watchlist; ?>','<?php echo $imageDataEncoded; ?>','<?php echo $dtype; ?>','<?php echo $apptitle; ?>','<?php echo $sno;?>','<?php echo $enduserid;?>','<?php echo $queryimage['name'];?>','<b><?php echo $queryimage['designation']; ?></b> (<?php echo  ago1($datefind); ?>)')"/></div>
										<?php 
										 } else { ?>
							...
							?>
								...
								<b>
									<div class="divboxname" style="float:left">
											...
											<div class="glyphicon glyphicon-search" onclick="showprevnext('<?php echo $r['_source']['sno']; ?>','<?php echo $r['_source']['enduserid']?>')" id="movefocus<?php echo $r['_source']['sno']; ?>" style="display:none;float:left;"></div>
											&nbsp;&nbsp;&nbsp; -->
											<div style="color:#3C5C9E;">
									<i>
										<div style="float:left;"><?php echo $apptitle;?></div>
