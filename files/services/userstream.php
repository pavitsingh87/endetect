...
if(isset($_REQUEST['ddatasearch']))
{
	...
	$decdatastr ='"query": { "query_string": { "default_operator" : "AND", "analyze_wildcard": true, "fields":["decdata"], "query" : "*'.$ddatasearch.'*" } },';
}
...
if(isset($results))
{
	foreach($results as $r)
	{
				...
				$queryim = $conn->query("select profilepic,name,designation,dept,groupid from U_endusers where sno='".$r['_source']['enduserid']."'");
				$queryimage = @$queryim->fetch_assoc();
					...
					<div class="dropdown" style="float:right;">
				     ...
				     <!-- post body start -->
						<div id="stbody6" class="stbody">
							...
							{
								?>
									<div class="sttext1" style="margin-left:2px;">
								<?php
							}
							else
							{
								?>
									<div class="sttext" style="margin-left:2px;">
								<?php
							}
							?>
								...
								<a id="6" class="stdelete" title="Delete update" href="#"> </a>
									...
									<div class="divboxname" style="float:left">
										<div style="float:left;color:#3C5C9E;"><?php echo $apptitle;?></div>
...
{
?>
<div class="panel-heading" onclick="loadmoreuserprofile(<?php echo $enduserid;?>,this)" id="loadmore<?php echo $r['_source']['sno'] ?>">
										<a ng-hide="ascrec">
